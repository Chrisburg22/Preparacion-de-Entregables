...
int main (){
    ...
    do{
        switch(elegirOpcionMenuProfesor()){
            ...
            case ACTUALIZACION: actualizarDatosProfesor(); break;
            case LISTADO: listarProfesores(); break;
...
void darBajaProfesor(){
    int i;
    char opcion;
    printf("BAJA DE UN PROFESOR\n\n");
    printf("Indica el numero de registo a consultar (1 a %d): ", MAX_PROFESORES);
    scanf("%d", &i);
    i--;
...
void actualizarDatosProfesor(){
    ...
    printf("ACTUALIZACION DE DATOS DE UN PROFESOR\n\n");
