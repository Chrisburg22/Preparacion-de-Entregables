...
int main(){
    ...
    circulo = new Circulo(radio,colorBorde,colorFondo);
...
void imprimirCirculo(Circulo* c){//& es paso de parametro por referencia, de esta manera no clonamos el dato, sino que le pasamos la ubicacion de el dato
    ...
    cout << "Color Fondo: " << c->getColorFondo() << endl;
    cout << "Area: " << c->getArea()<< endl << endl;
}

void capturarDatos(double* radio, int* colorBorde, int* colorFondo){//Recibe direcciones de memoria como parametro
    cout << "Capturando datos" << endl;
    cout << "Radio: ";
    cin >> *radio;// Esto se lee: "A donde apunta radio, guarda lo escaneado en consola"
    cout << "Color borde: ";
    cin >> *colorBorde;
    cout << "Color fondo: ";
    cin >> *colorFondo;
