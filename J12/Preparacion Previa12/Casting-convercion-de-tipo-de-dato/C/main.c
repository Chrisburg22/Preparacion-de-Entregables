...
int main(){
    ...
    promedioEdadAmigos = (float)(edadAmigos1+edadAmigos2+edadAmigos3+edadAmigos4+edadAmigos5) / CANTIDAD_AMIGOS ;
    ...
    printf("Le edad promedio de mis amigos es %f", promedioEdadAmigos);
